...
const ducksInThePond = [
	...
	},
	{
		...
		name: 'Darth Quacker',
		imgUrl:
			'https://www.duckshop.de/media/image/3c/ce/25/Black_Star_Badeente_58495616_4_600x600.jpg',
	...
	},
	{
		...
		imgUrl:
			'https://www.duckshop.de/media/image/91/86/a1/Nerd_Badeente_67685078_600x600.jpg',
	...
	},
	{
		...
		name: 'Quacker',
		imgUrl:
			'https://m.media-amazon.com/images/I/61iqP4VFsEL.__AC_SX300_SY300_QL70_ML2_.jpg',
	...
	},
	{
		...
		imgUrl:
			'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbw5dFwbwPw_Uf_KTKU94mljxvtCcZzMCmKA&s',
		quote: ''
	}
];
...
// summonBtn.addEventListener('click', () => console.log('Clicked!'));

// will override previous events listeners
// summonBtn.onclick = () => renderDucks(ducksInThePond, pond);
// summonBtn.onclick = () => console.log('Clicked!');
...
addForm.addEventListener('submit', (e) => {
	...
	try {
		...
		const newDuck = {
			_id: ducksInThePond.length, // don't actually do this
			name: name.value,
			imgUrl: imgUrl.value,
			quote: quote.value
		};
