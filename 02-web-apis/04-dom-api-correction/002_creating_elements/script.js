...
//     *   Inside the `nav`,
// create an `a` element with the class `logo` and the text "Coffee Shop".
const logo = document.createElement('a');
logo.className = 'logo';
logo.textContent = 'Coffee Shop';
nav.appendChild(logo);

//     *   Create a `ul` element with the class `nav-list`.
// Inside the `ul`, create four `li` elements with the class `nav-item`,
...
//  (tip: you can set a `mouseover` and a `mouseout` event for this)
...
// Now, is this practical? Certainly no! But you gotta learn and get
// comfortable with the DOM API ❤️
