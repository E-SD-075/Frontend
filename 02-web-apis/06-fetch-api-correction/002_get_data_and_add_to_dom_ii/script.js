// *   **Fetch Data:** Write JavaScript to fetch data for the first 150 Pokémon from the
// Pokémon API. [More info can be found here](https://pokeapi.co)
...
const fetchAndRenderPokemon = async () => {
	for (let i = 1; i <= 151; i++) {
		...
		if (pokemon) {
			renderPokemonCard(pokemon, pokemonContainer);
		}
	}
};
