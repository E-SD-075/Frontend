...
//     *   Create an array called `numbers` containing the
...
//  where each value is the corresponding number in `numbers`
// converted to a string with the prefix "Number: ".
...
//where each value is an object with the properties `original` (the original number) and
// `squared` (the square of the number).
