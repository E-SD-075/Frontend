...
//     *   Declare a function named `greet` that logs
...
//     *   Declare a function named `square` that takes
// a number as a parameter and returns its square.
//     *   Call the function with the argument `5`,
// store the result in a variable, and output it to the console.
function square(num) {
	return num * num;
}
let result = square(5);
...
// 3.  **Declare a function with one parameter that performs a
// control flow with a switch statement and returns accordingly.**

//     *   Declare a function named `getDayName` that takes a number
// (0-6) as a parameter and returns the name of the day.
//     *   Use a switch statement to determine the day name.
//     *   Call the function with the argument `3`,
// store the result in a variable, and output it to the console.

const dayOf3 = getDayName(3);
function getDayName(num) {
	switch (num) {
		...
		case 6:
			return 'Sunday';
		default:
			return 'Invalid number, valid numbers are 0-6';
	}
}

console.log('dayOf3:', dayOf3);
